    ...
    <div>
      ...
      <section className="flex justify-center mb-15">
        <div className="container flex flex-col gap-8">
          ...
          <div className="grid grid-rows-2 md:grid-rows-1 grid-cols-2 md:grid-cols-5">
            {products.slice(25, 30).map((el, index) => {
              return (
                <div
                  key={index}
                ...
                >
                  <div className="flex flex-col pt-8">
                    <div className="absolute top-4 left-4 flex bg-lightGreen/10 py-0.75 px-2 rounded-sm gap-1">
                      <p className="font-poppins text-[14px] text-darkGreen animate__animated animate__heartBeat animate__slow animate__infinite	infinite">
                        New
                      </p>
                    </div>
                    <img
